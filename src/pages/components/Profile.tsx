    ...
    >
      <section className=" w-[40%]  mx-auto bg-[#20354b] rounded-2xl px-8 py-6 shadow-lg">
        ...
        <div className="mt-6 w-fit mx-auto">
          <img
            src="https://scontent.fhan14-2.fna.fbcdn.net/v/t39.30808-6/378229932_708960944407464_1201804895590157296_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=5f2048&_nc_ohc=QKPapXj7A2wAX_aclZa&_nc_ht=scontent.fhan14-2.fna&oh=00_AfBKlY30MZKC85xLbqhg-e2V9uvc2CPWK2KDza-xZGPNvA&oe=656527A8"
